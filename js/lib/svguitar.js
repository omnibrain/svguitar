...
})(BarreChordStyle = exports.BarreChordStyle || (exports.BarreChordStyle = {}));
/**
...
var SVGuitarChord = /** @class */ (function () {
    ...
    SVGuitarChord.prototype.drawGrid = function (y) {
        ...
        this.chordInternal.barres.forEach(function (_a) {
            ...
            if (barreChordStyle == BarreChordStyle.RECTANGLE) {
                ...
                _this.renderer.rect(rectX, rectY, rectWidth, rectHeight, barreChordStrokeWidth, barreChordStrokeColor, classNames, (_g = 'black' !== null && 'black' !== void 0 ? 'black' : color) !== null && _g !== void 0 ? _g : fingerColor, fingerSize * barreChordRadius);
            }
        ...
        if ((_l = this.settings.showFretMarkers) !== null && _l !== void 0 ? _l : defaultSettings.showFretMarkers) {
            (_m = this.settings.fretMarkers) === null || _m === void 0 ? void 0 : _m.forEach(function (fretMarker) {
                ...
                var fretMarkerCenterX = constants_1.constants.width / 2;
    ...
    SVGuitarChord.prototype.drawFinger = function (x, y, size, color, textSize, fontFamily, fingerOptions, classNames) {
        ...
        if (fingerOptions.text) {
            ...
            this.renderer.text(fingerOptions.text, textX, textY, textSize, (_l = fingerOptions.textColor) !== null && _l !== void 0 ? _l : fingerTextColor, fontFamily, renderer_1.Alignment.MIDDLE, textClassNames, true);
        }
    };
    SVGuitarChord.prototype.drawShape = function (shape, x, y, size, strokeWidth, strokeColor, fillColor, classNames) {
        switch (shape) {
            ...
            case Shape.PENTAGON:
                ...
                break;
            default:
                throw new Error("Invalid shape \"".concat(shape, "\". Valid shapes are: ").concat(Object.values(Shape)
